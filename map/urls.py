...
urlpatterns = [
    ...
    url(r'^chat_hello/', csrf_exempt(skills_chat.say_hello.as_view())),
    url(r'^chat_simple_answer/', csrf_exempt(skills_chat.simple_ans.as_view())),
    url(r'^chat_idiot/', csrf_exempt(skills_chat.idiot.as_view())),
    url(r'^chat_meal/', csrf_exempt(skills_chat.meal.as_view())),
